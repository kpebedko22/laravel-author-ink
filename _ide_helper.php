...
')
     ...
     */
         ...
         * @param string $model
                     * @static
                     *@see \App\Mixins\FilamentViewComponentMixin::translate()
         */
        public static function translate($model)
        {
                        return \Filament\Support\Components\ViewComponent::translate($model);
        }
     ...
     */
        ...
        public static function translate($model)
        {
                        return \Filament\Support\Components\Component::translate($model);
        }
